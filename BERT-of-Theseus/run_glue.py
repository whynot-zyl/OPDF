            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.logging_steps > 0 and global_step % args.logging_steps == 0:
                    ...
                    if args.task_name == 'sts-b':
                        if logs['eval_spearmanr'] > f1_mark:
                            f1_mark = logs['eval_spearmanr']
                            f1_test = logs_test['test_spearmanr']
                            log_dev = results
                    ...
                    # 将数据存储为文本文件
                    file_path = f"/mnt/zhanyuliang/data/checkpoint/nlp/theseus/result/{args.task_name}_{args.learning_rate}_{args.replacing_rate}_{args.scheduler_linear_k}.txt"
