...
def train(args, train_dataset, model, tokenizer):
    """ Train the model """
    print("########################################################################################`#################")
    print(str(sum(p.numel() for p in model.bert.encoder.layer.parameters() if p.requires_grad)))
    print("#########################################################################################################")
    print("#########################################################################################################")
    print(str(sum(p.numel() for p in model.bert.encoder.scc_layer.parameters() if p.requires_grad)))
    print("#########################################################################################################")
    ...
    print("#########################################################################################################")
    print(str(sum(p.numel() for group in optimizer.param_groups for p in group['params'])))
    print("#########################################################################################################")
